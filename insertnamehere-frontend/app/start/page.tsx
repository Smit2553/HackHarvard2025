      ...
      <div className="max-w-2xl w-full mx-auto px-6">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            Practice coding interviews with an AI interviewer that provides real-time feedback
          </p>
          ...
          <div className="mb-10 space-y-3 text-left max-w-md mx-auto">
            <div className="flex items-start gap-3">
              ...
              <span className="text-gray-700 dark:text-gray-300">Voice-enabled AI interviewer</span>
            </div>
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700 dark:text-gray-300">Full-featured code editor</span>
            </div>
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700 dark:text-gray-300">Real-time feedback on your code</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={isStarting}
            className="w-full max-w-sm mx-auto bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-4 px-8 rounded-lg transition-colors duration-200 flex items-center justify-center gap-3"
          >
            {isStarting ? (
              <>
          ...
          <p className="mt-8 text-sm text-gray-500 dark:text-gray-400">
            Make sure your microphone is enabled. The interview will start immediately after clicking.
          </p>
        </div>
      </div>
    </div>
